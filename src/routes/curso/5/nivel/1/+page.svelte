...
<div class="container">
	<div class="header">
		<h1>Vídeo: Introducción a la prespectiva</h1>
	</div>
	<div class="video-container">
		<iframe
			title=""
			src="https://www.youtube.com/embed/KzTQAuZ06EI"
			frameborder="0"
...
<a href="./2" data-sveltekit-reload data-sveltekit-preload-data="tap">
	<Next />
</a>
